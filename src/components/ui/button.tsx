...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:outline-2 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-purple-500',
  {
    variants: {
      variant: {
        default:
