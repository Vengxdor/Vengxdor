...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap hover:-translate-y-[2px] transition-transform duration-200 rounded-md text-[15px] font-medium transition-colors focus-visible:outline-none focus-visible:outline-2 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-purple-500',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow  hover:bg-accent dark:bg-primary dark:text-primary-foreground dark:hover:bg-accent',
        destructive:
